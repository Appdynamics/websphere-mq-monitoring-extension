...
public class TopicMetricsCollectorTest {
    ...
    public void testpublishMetrics() throws MQException, IOException, TaskExecutionException {
        ...
        classUnderTest = new TopicMetricsCollector(topicMetricsToReport, monitorContextConfig, pcfMessageAgent, queueManager, metricWriteHelper, Mockito.mock(Phaser.class));
