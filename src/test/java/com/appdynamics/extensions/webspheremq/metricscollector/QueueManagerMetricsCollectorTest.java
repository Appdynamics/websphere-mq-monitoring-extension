...
public class QueueManagerMetricsCollectorTest {
    ...
    public void setup() {
        ...
        queueMetricsToReport = metricsMap.get(Constants.METRIC_TYPE_QUEUE_MANAGER);
    }
    ...
    public void testProcessPCFRequestAndPublishQMetricsForInquireQStatusCmd() throws MQException, IOException, TaskExecutionException {
        ...
        classUnderTest = new QueueManagerMetricsCollector(queueMetricsToReport, monitorConfiguration, pcfMessageAgent, queueManager, metricWriteHelper);
